...
{
    /// <summary>
    /// automatische Verteilung der Aufgaben an einen Worker
    /// via Config kann ein Router dazwischen gezogen werden
    /// </summary>
    public class ConfigRoutingMaster : ReceiveActor
    {
        /// <summary>
        ...
        /// </summary>
        public ConfigRoutingMaster()
        {
            Console.WriteLine("Starting Non Routing Master {0}", Self.Path.Name);
